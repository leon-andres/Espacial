...
lista_librerías<-c("readr","sqldf","tidyr","tidyverse","ggplot2","patchwork","sp","fields","geoR","akima","shiny","gstat", "sf", "dplyr") 
...
-   **Wave con pepita fija:** 1.992

-   **Wave con pepita libre:** 2.020

-   **Exponencial con pepita libre:** 2.220
...
#| message: false
#| warning: false
PM10_2022sf <- st_as_sf(PM10_2022, coords = c("Longitud", "Latitud"), crs = CRS_UTM_CO)
...
scale_color_viridis_c(option = "plasma", name = "Valor") +
  labs(title = "Partículas PM2.5 en Bogotá año 2022",
       x = "Longitud",
       y = "Latitud") +
  theme_minimal()
```

### Relación PM10 vs coordenadas
...
lm_PM10 <- lm(PM10 ~ Longitud + Latitud + I(Longitud*Latitud), data = PM10_2022)
