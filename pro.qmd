...
lista_librerías<-c("readr","sqldf","tidyr","tidyverse","ggplot2","patchwork","sp","fields","geoR","akima","shiny","gstat", "sf") 
...
#| warning: false
#| message: false
bogota_shp <- st_read("loca.shp")    # Localidades de Bogotá
